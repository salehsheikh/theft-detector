...
const FilterSection = () => {
  ...
  return (
    <div className='rounded-[20px] lg:h-[127px] py-5 md:px-[33px] px-2  bg-[color:var(--color-darkest)]'>
      <div className='flex-col space-y-7.5'>
        <p className='text-sm text-white font-semibold'> Filters</p>
        <div>
          <div className='grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 xl:gap-11 gap-2.5 md:px-6 px-1.5'>
