...
const AlertsTable = () => {
  ...
  return (
    ...
    <div className='bg-[color:var(--color-darkest)] overflow-y-auto rounded-[20px] max-h-[432px] h-full py-[29px] px-[33px] space-y-[15px]'>
        <div className='flex justify-between border border-b-white space-y-[15px]'>
            ...
            <div className='flex gap-7 items-center'>
                ...
                className='text-base text-[#0D0D0D] px-[31px] py-3.5 rounded-[10px] font-semibold bg-[#B1ED00] w-[167px] h-12'>
                    View Clip
                </button>
                <button
                onClick={()=>setIsFeedModalOpen(true)}
                 className='text-base text-[#0D0D0D] px-[31px] py-3.5 rounded-[10px] font-semibold bg-[#FFFFFF66] w-[167px] h-12'>
                    Live Feed
                </button>
